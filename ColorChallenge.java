...
public class ColorChallenge {
    ...
    public static final char[] COLORS = {'B', 'R', 'G', 'B'};
    ...
    private void printGameWithBlock(Block block) {
        for (int y = 0; y < row; y++) {
            for(int x = 0; x < col; x++) {
                Node n = getNode(x, y);
    ...
    private Block getContinousBlock(int x, int y) {
    ...
    public static void main(String[] args) {
        ...
        if (block != null) {
            System.out.println();
            System.out.println();
            System.out.println(MessageFormat.format("===============================  FOUND LARGEST BLOCK IN {0}ms  =============================== ",endTime - startTime));
            System.out.println();
